...
import org.openftc.easyopencv.OpenCvWebcam;
    ...
    @TeleOp
    public class ColorHSV extends LinearOpMode
    {
        OpenCvWebcam webcam;
        ...
        public void runOpMode()
        {
             ...
             */
            webcam.setPipeline(new ColorHSV.rectangle_thresholder_pipeline());
...
//                telemetry.addData("Theoretical max FPS", webcam.getCurrentPipelineMaxFps());
        ...
        public class rectangle_thresholder_pipeline extends OpenCvPipeline {
            ...
            private Point topLeft1 = new Point(0, 0), bottomRight1 = new Point(479, 639);
